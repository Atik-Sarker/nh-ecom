...
@section('content')
        ...
        <div class="container">
            <ol class="breadcrumb-page">
                @foreach($allData[2] as $pdt)
                    ...
                    <li class="active"><a href="{{url('/')}}/{{replace($pdt->cname)}}/{{$pdt->cid}}">{{$pdt->cname}}</a>
                    </li>
                    <li class="active"><a href="{{url('/')}}/{{replace($pdt->cname)}}/{{replace($pdt->scname)}}/{{$pdt->cid}}">{{$pdt->scname}}</a>
                    </li>
                @endforeach
            </ol>
        </div>
                    ...
                    <div class="col-md-4 col-sm-12 padding-right">
                        <div class="product-media">
                            <div class="image-preview-container image-thick-box image_preview_container">
                                <img id="img_zoom" data-zoom-image="images/detail/thick-box-1.jpg"
                                     src="{{url('/')}}/{{pictureHelper($pdt->id, $pdt->picture1, $pdt->picture2, $pdt->picture3)}}" alt="">
                            ...
                            <div class="product-preview image-small product_preview">
                                <div id="thumbnails" class="thumbnails_carousel owl-carousel nav-style4" data-nav="true"
                                    ...
                                    <a href="#" data-image="images/detail/thick-box-1.jpg"
                                       data-zoom-image="images/detail/thick-box-1.jpg">
                                        <img src="images/detail/i1.jpg" data-large-image="images/detail/thick-box-1.jpg"
                                             alt="i1">
                                    </a>
                                    <a href="#" data-image="images/detail/thick-box-1.jpg"
                                       data-zoom-image="images/detail/thick-box-1.jpg">
                                        <img src="images/detail/i2.jpg" data-large-image="images/detail/thick-box-1.jpg"
                                             alt="i1">
                                    </a>
                                    <a href="#" data-image="images/detail/thick-box-1.jpg"
                                       data-zoom-image="images/detail/thick-box-1.jpg">
                    ...
                    <div class="col-md-5 col-sm-6">
                        <div class="product-info-main">
                            ...
                            <div class="product-description">
                                ...
                                piece of classical Latin literature from 45 making it over 2000 years old.
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="product-info-price">
                            ...
                            <div class="quantity">
                                ...
                                <div class="buttons-added">
                                    ...
                                    <input type="text" value="{{$value}}" title="Qty" name="qty" id="qty"  class="input-text qty text" size="1">
                                    <a href="#" class="sign plus"><i class="fa fa-plus"></i></a>
                                    <a href="#" class="sign minus"><i class="fa fa-minus"></i></a>
                                </div>
                            </div>
                            <div class="single-add-to-cart">
                                <button class="btn btn-primary" id="atc" type="submit">Add to cart</button>
                            ...
                            <form method="post" action="#" class="new-review-form">
                                ...
                                <div class="form-content">
                                    ...
                                    <p class="form-row form-row-wide">
                                        ...
                                        <textarea aria-invalid="false" class="textarea-control" rows="5" cols="40"
    ...
    @php
       ...
       // print_r(Session::get("qtyId"));
         //echo Session::get('pdtId');
         //echo Session::get('qtyId');
             //Session::flush('pdtId');
             //Session::flush('qtyId');
    @endphp
