...
<footer class="site-footer footer-opt-1 newsletter-icon">
    ...
    <div class="copyright full-width">
        <div class="container">
            ...
            <div class="pay-men">
                <a href="#"><img src="{{asset('public/fontEnd/images/home1/pay1.jpg')}}" alt="pay1"></a>
                <a href="#"><img src="{{asset('public/fontEnd/images/home1/pay2.jpg')}}" alt="pay2"></a>
                <a href="#"><img src="{{asset('public/fontEnd/images/home1/pay3.jpg')}}" alt="pay3"></a>
                <a href="#"><img src="{{asset('public/fontEnd/images/home1/pay4.jpg')}}" alt="pay4"></a>
            </div>
        </div>
    </div>
</footer><!-- end FOOTER -->
...
<script type="text/javascript" src="{{asset('public/fontEnd/js/jquery-ui.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/owl.carousel.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/wow.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/jquery.actual.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/chosen.jquery.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/jquery.bxslider.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/jquery.sticky.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/jquery.elevateZoom.min.js')}}"></script>
<script src="{{asset('public/fontEnd/js/fancybox/source/jquery.fancybox.pack.js')}}"></script>
<script src="{{asset('public/fontEnd/js/fancybox/source/helpers/jquery.fancybox-media.js')}}"></script>
<script src="{{asset('public/fontEnd/js/fancybox/source/helpers/jquery.fancybox-thumbs.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/function.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/Modernizr.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/jquery.plugin.js')}}"></script>
<script type="text/javascript" src="{{asset('public/fontEnd/js/jquery.countdown.js')}}"></script>
</body>
