                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" id="form" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="number" class="form-control" name="contact" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="g-recaptcha" data-sitekey="6LcpBmMUAAAAANLJY6n4qch-2vnotFQKB4c_d4H2"></div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            $('#country').change(function () {
                ...
                $("#city").html("");
                if (cnt == 0){
                    $("#city").append("<option value='0'>Choose Country First...</option>");
                }
                <?php
                ...
                foreach ($allCnt as $cnt){
                    ...
                    foreach ($allCt as $ct){
                        if ($ct->country_id == $cnt->id){
                            echo "$(\"#city\").append(\"<option value='$ct->id'>$ct->name</option>\");";
                        }
                    }
                    echo "}";
                }
